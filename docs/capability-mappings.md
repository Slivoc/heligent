...
The directory is a JSF form with session/view-state and AJAX responses, rather than an advertised API in the inspected interface. An adapter is feasible, but has **not been implemented or run as an import** in this change.
